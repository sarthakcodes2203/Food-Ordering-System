<%@ Page Title="" Language="C#" MasterPageFile="~/UserScreen/User.master" AutoEventWireup="true" CodeFile="Payment.aspx.cs" Inherits="UserScreen_Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section" style="background-image: url('../Images/'); width: 100%; height: 100%; background-repeat: no-repeat; background-size: auto; background-attachment: fixed; background-position: left;">
                        ...
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    <li class="nav-item"><a data-toggle="pill" href="#credit-card" class="nav-link active "><i class="fa fa-credit-card mr-2"></i>Card </a></li>
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money mr-2"></i>Cash On Delivery </a></li>
                                    <li class="nav-item"><a data-toggle="pill" href="#upi" class="nav-link "><i class="fa fa-mobile mr-2"></i>UPI </a></li>
                                </ul>
                                <!-- End -->
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Card Holder Name is required"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <asp:TextBox ID="txtCvv" runat="server" CssClass="form-control" placeholder="CVV No."></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Delivery Address is required" ForeColor="Red"
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lblCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm" ValidationGroup="card" OnClick="lblCardSubmit_Click">
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCODAddress" runat="server" ErrorMessage="Delivery Address is required" ForeColor="Red"
                                            ControlToValidate="txtCODAddress" Display="Dynamic" SetFocusOnError="true" ValidationGroup="cod">*</asp:RequiredFieldValidator>
                                ...
                                <div id="upi" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        <div class="container mt-4 border-0 d-flex flex-column justify-content-center align-items-center">
                                            <asp:Image ID="imgQRCode" runat="server" Height="200" />
                                            <p class="mt-3">
                                                UPI No:- &nbsp;
                                                <asp:Label ID="lupino" runat="server" Font-Bold="true"></asp:Label>
                                            </p>
                                            <p>
                                                UPI ID:- &nbsp;
                                                <asp:Label ID="lupiid" runat="server" Font-Bold="true"></asp:Label>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="revtransid" runat="server" ErrorMessage="UPI Transaction ID should be of 12 digits" ValidationExpression="^\d{12}$"
                                             ControlToValidate="txttransid" Display="Dynamic" ForeColor="Red" ValidationGroup="upi"></asp:RegularExpressionValidator>
                                        <asp:RequiredFieldValidator ID="rfvtransid" runat="server" ErrorMessage="UPI Transaction ID is required" ForeColor="Red"
                                            ControlToValidate="txttransid" Display="Dynamic" SetFocusOnError="true" ValidationGroup="upi">*</asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txttransid" runat="server" CssClass="form-control" placeholder="e.g. 456287359844"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <label for="txtupiAddress">
                                            <h6>Delivery Address</h6>
                                        </label>
                                        <asp:RequiredFieldValidator ID="rfvupiAddress" runat="server" ErrorMessage="Delivery Address is required" ForeColor="Red"
                                            ControlToValidate="txtupiAddress" Display="Dynamic" SetFocusOnError="true" ValidationGroup="upi">*</asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtupiAddress" runat="server" CssClass="form-control" placeholder="Delivery Address"
                                            TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                    <p>
                                        <asp:LinkButton ID="lnkupiSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="upi" OnClick="lnkupiSubmit_Click">
                                            <i class="fa fa-cart-arrow-down mr-2"></i>Confirm Order</asp:LinkButton>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="pt-2">
                                ...
                                <asp:ValidationSummary ID="ValidationSummary2" runat="server" ForeColor="Red" ValidationGroup="cod"
                                    HeaderText="Fix the following errors" Font-Names="Segoe Script" />
                                <asp:ValidationSummary ID="ValidationSummary3" runat="server" ForeColor="Red" ValidationGroup="upi"
                                    HeaderText="Fix the following errors" Font-Names="Segoe Script" />
                            </div>
                        </div>
                    </div>
