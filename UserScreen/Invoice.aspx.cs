...
public partial class UserScreen_Invoice : System.Web.UI.Page
{
    ...
    protected void lbDownloadInvoice_Click(object sender, EventArgs e)
    {
        try
        {
            string downloadPath = @"D:\order_incoice.pdf";
        ...
        {
            lblMsg.Visible = true;
            lblMsg.Text = "Problem in Downloading Invoice:"+ex.Message.ToString();
